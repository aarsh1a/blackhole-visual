...
export default class BlackHole {
    ...
    setCommonUniforms() {
        this.commonUniforms = {}
        this.commonUniforms.uInnerColor = { value: new THREE.Color('#FFC067') }
        this.commonUniforms.uOuterColor = { value: new THREE.Color('#FFC067') }
    ...
    update() {
        ...
        const rotationSpeedFactorin = 0.1
        const rotationSpeedFactorout = 0.1
        this.disc.material.uniforms.uTime.value = this.time.elapsed * rotationSpeedFactorin
        this.particles.material.uniforms.uTime.value = this.time.elapsed * rotationSpeedFactorout
